...
The division into 6 discrete CRT viewports occurs **entirely inside the GPU fragment shader** ([`CompositeShader.ts`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/shaders/CompositeShader.ts#L8)). 
...
*(Defined in code as [`MATRIX_QUADRANTS`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/MatrixSplitter.ts#L46) in [`src/rendering/MatrixSplitter.ts`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/MatrixSplitter.ts)).*
...
#### 1. Optical Capture
- Managed by [`CameraManager`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/CameraManager.ts#L5).
...
- Managed by [`MediaPipeTracker`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/MediaPipeTracker.ts#L24).
...
- Handled by [`FeatureExtractor`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/FeatureExtractor.ts#L17).
- Converts raw coordinates into semantic visitor states:
  ...
  - **Semantic Key Poses**: Detects signature body postures (`POSE_ANTENNA`, `POSE_SURPRISE`, `POSE_WINGSUIT`).
...
- Handled by [`InteractionController`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/InteractionController.ts#L12).
...
- Managed by [`synthesizeBroadcastQuery`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/BroadcastQuerySynthesizer.ts#L141).
...
- Sends query to [`VideoQueue`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/video/VideoQueue.ts#L63), which fetches or matches local videos and seamlessly cues playback.

#### 6. Continuous Physical Mapping (The Human Antenna)
- Handled continuously by [`GestureMapper`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/vision/GestureMapper.ts#L8).
...
- Centralized in [`useAppStore`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/core/StateManager.ts#L452).
- Updates reactive state slices without triggering React-style DOM re-renders.

#### 8. Cross-Window Synchronization (SyncChannel)
- Managed by [`SyncChannel`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/core/SyncChannel.ts#L109).
...
- Executed by [`SceneManager`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/SceneManager.ts#L20) and [`compositeFragmentShader`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/shaders/CompositeShader.ts#L8).
...
- Managed by [`AudioEngine`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/audio/AudioEngine.ts#L9).
- Dynamically mixes:
...
To allow installation curators to calibrate the screens on-site without revealing UI panels to visitors, V-FEED [06] uses a distributed multi-window architecture connected via [`SyncChannel`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/core/SyncChannel.ts#L109):
...
2. **Never allocate objects inside the animation loop**. All vectors, arrays, and matrices used in [`App.ts`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/core/App.ts#L21) and [`SkeletonOverlay.ts`](file:///Users/mclovin/Documents/pabellon/v-feed-06/src/rendering/SkeletonOverlay.ts#L131) are pre-allocated.
...
*Next Step: Explore [02. Frontend Core & State Management](file:///Users/mclovin/Documents/pabellon/v-feed-06/docs/architecture/02-frontend-core-and-state.md) to dive into application orchestration and state architecture.*
